...
const oldScopes = ["ugc-image-upload", "streaming", "user-library-modify", "user-library-read", "user-read-birthdate", "user-read-email", "user-read-private", "user-modify-playback-state", "user-read-private", 
"user-read-private", "user-top-read", "user-read-recently-played", "playlist-modify-public", "playlist-modify-private", "playlist-read-collaborative", "playlist-read-private"];

const jssdkscopes = ["user-library-modify", "user-library-read", "user-read-email", "user-read-private", "user-modify-playback-state", "user-read-private", 
                     "user-read-private", "user-top-read", "playlist-modify-public", "playlist-modify-private", "playlist-read-collaborative", "playlist-read-private"];
